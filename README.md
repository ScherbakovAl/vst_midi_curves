...
Кроссплатформенный VST3 плагин и standalone приложение для обработки MIDI-сообщений с помощью настраиваемых кривых передаточных функций.
...
Проект находится в стадии планирования. Подробный архитектурный план см. в [`ARCHITECTURE.md`](ARCHITECTURE.md).
